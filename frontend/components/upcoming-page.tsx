    ...
    <div className="space-y-4">
      ...
      <div ref={calendarRef} className="upcoming-cal rounded-panel border border-c-border bg-c-surface p-4 card-interactive">
        ...
        <div className="mt-3 space-y-2">
          <Link href="/integrations" aria-label="Conectar Google Calendar" className="block rounded-card border border-c-border bg-c-surface-2 px-4 py-3.5 sm:py-2.5 text-center text-[13px] sm:text-[12px] text-c-muted transition-colors hover:bg-c-surface focus-visible:outline-none">
            Conectar Google Calendar
          </Link>
          <Link href="/integrations" aria-label="Conectar Microsoft Outlook" className="block rounded-card border border-c-border bg-c-surface-2 px-4 py-3.5 sm:py-2.5 text-center text-[13px] sm:text-[12px] text-c-muted transition-colors hover:bg-c-surface focus-visible:outline-none">
